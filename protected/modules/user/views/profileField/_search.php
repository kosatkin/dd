<div class="wide form">
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'varname',array(
    'size'=>50,
    'maxlength'=>50
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'match',array(
    'size'=>60,
    'maxlength'=>255
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'range',array(
    'size'=>60,
    'maxlength'=>255
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'error_message',array(
    'size'=>60,
    'maxlength'=>255
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'other_validator',array(
    'size'=>60,
    'maxlength'=>5000
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'default',array(
    'size'=>60,
    'maxlength'=>255
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'widget',array(
    'size'=>60,
    'maxlength'=>255
  )); ?>
  </div>
  ...
  <div class="row">
    ...
    <?php echo $form->textField($model,'widgetparams',array(
    'size'=>60,
    'maxlength'=>5000
  )); ?>
  </div>
