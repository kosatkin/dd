    ...
    if(Yii::app()->request->isPostRequest)
    {
      ...
      if($scheme=='CSqliteSchema')
      {
        ...
        try
        {
          ...
          $connection->createCommand(
            "INSERT INTO ".Profile::model()->tableName()."_backup SELECT ".implode(',',$attr)." FROM ".Profile::model()
              ->tableName()
          )->execute();
          ...
          $connection->createCommand(
            "INSERT INTO ".Profile::model()->tableName()." SELECT ".implode(',',$attr)." FROM ".Profile::model()
              ->tableName()."_backup"
          )->execute();
