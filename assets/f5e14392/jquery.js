...
(function(window, undefined)
{
  ...
  jQuery.event = {
    ...
    remove: function(elem, types, handler, selector, mappedTypes)
    {
      ...
      for(t = 0; t < types.length; t++)
      {
        ...
        namespaces =
          namespaces?new RegExp("(^|\\.)" + namespaces.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)"):null;
  ...
  function inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR, dataType /* internal */, inspected
    /* internal */)
  {
